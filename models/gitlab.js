...
Gitlab.prototype.updateIssue = async function(id_project, id_issue, state) {
  ...
  var delete_path = path.concat(id_project, "/issues/", id_issue, "?private_token=");
...
Gitlab.prototype.getProjets = async function() {
  ...
  this._total = [];
  this._total.push(this._algo, this._web, this._mobile, this._api, this._devops);
  this._total_nb_done = this._algo._nb_done + this._web._nb_done + this._mobile._nb_done + this._api._nb_done + this._devops._nb_done;
  this._total_nb_doing = this._algo._nb_doing + this._web._nb_doing + this._mobile._nb_doing + this._api._nb_doing + this._devops._nb_doing;
  this._total_nb_todo = this._algo._nb_todo + this._web._nb_todo + this._mobile._nb_todo + this._api._nb_todo + this._devops._nb_todo;
}
